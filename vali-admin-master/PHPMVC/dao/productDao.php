...
class ProductDao extends BaseDao{
    ...
    public function _anotherSelect(){
        $res=parent::query('select a.product_id,a.product_name,a.product_licensenum,a.product_person,c.producttype_name,a.product_state,a.product_costprice,a.product_rentalprice,a.product_cashpledge 
