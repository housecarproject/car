            ...
            try {
                ...
                for (var i = 0; i < $res.length; i++) {
                    ...
                    <tr>
                        ...
                        <td><button type="button" class="btn btn-primary" onclick="checkDetail(${$res[i]['user_id']})" >查看详情</button></td>
                    </tr>`;
                }
...
function checkDetail(userid){
    // console.log(userid);
    $(".user_detail_show").siblings("div").hide();
    $(".user_detail_show").show();
    $.ajax({
        url:'./../PHPMVC/index.php',
        type: 'post',
        data: {
                ...
                for (var i = 0; i < $res.length; i++) {
                    if($res[i]['user_id']==userid){                       
                        ...
                        <tr>
                            ...
                            <td>${$res[i]['user_address']}</td>
                        </tr>`;
                    }
                }
                $(".user_detail_show tbody").html(str);
            } catch (e) {
                console.log('服务器出错！');
            }
        }
...
//退出详情
$(".exitUserDetail").click(function(){
    $(".user_detail_show").hide();
    $(".user_content").show();
